	...
	*/
	...
	public function formatForDisplay( $value, $formValue, $type='listing', $record=NULL )
	{
		...
		else if ( $type === 'thumbs' and $this->type === 'Upload' )
		{
			...
			{
				$thumbs = iterator_to_array( \IPS\Db::i()->select( '*', 'cms_database_fields_thumbnails', array( array( 'thumb_field_id=?', $this->id ) ) )->setKeyField('thumb_original_location')->setValueField('thumb_location') );
				$images = array();
