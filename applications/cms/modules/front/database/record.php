...
class _record extends \IPS\Content\Controller
{
	...
	protected function manage()
	{
		...
		\IPS\Output::i()->jsonLd['article']	= array(
			...
			'name'			=> htmlspecialchars( $record->_title, ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE ),
			'headline'		=> htmlspecialchars( $record->_title, ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE ),
			...
			'author'		=> array(
				'@type'		=> 'Person',
				'name'		=> htmlspecialchars( \IPS\Member::load( $record->member_id )->name, ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE ),
				'url'		=> (string) \IPS\Member::load( $record->member_id )->url(),
