...
class _view extends \IPS\Helpers\CoverPhoto\Controller
{
	...
	protected function manage()
	{
		...
		\IPS\Output::i()->jsonLd['blog']	= array(
			...
			'name'			=> htmlspecialchars( $this->blog->_title, ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE ),
		...
		if( $this->blog->member_id )
		{
			\IPS\Output::i()->jsonLd['blog']['author'] = array(
				'@type'		=> 'Person',
				'name'		=> htmlspecialchars( \IPS\Member::load( $this->blog->member_id )->name, ENT_QUOTES | \IPS\HTMLENTITIES, 'UTF-8', FALSE ),
