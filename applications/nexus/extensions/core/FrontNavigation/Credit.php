<?php
/**
 * @brief		Front Navigation Extension: Account Credit
...
class _Credit extends \IPS\core\FrontNavigation\FrontNavigationAbstract
{
	...
	{
		return \IPS\Http\Url::internal( "app=nexus&module=clients&controller=credit", 'front', 'clientscredit', \IPS\Settings::i()->nexus_https );
	}
