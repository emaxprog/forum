<?php
/**
 * @brief		Front Navigation Extension: Billing Agreements
...
{	
	...
	{
		return \IPS\Http\Url::internal( "app=nexus&module=clients&controller=billingagreements", 'front', 'clientsbillingagreements', \IPS\Settings::i()->nexus_https );
	}
