...
class _Upgrade
{
	...
	public function step1()
	{
		...
		\IPS\Db::i()->update( 'core_sys_conf_settings', array( 'conf_value' => json_encode( $newValueToSave ) ), array( 'conf_key=?', 'furl_configuration' ) );
	...
	{
		return "Updating Friendly URL customisations";
	}
