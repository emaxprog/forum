...
class _onlineusers extends \IPS\Task
{
	...
	public function execute()
	{
		...
		try
		{
			$onlineGuests = \IPS\Db::i()->select( 'COUNT(*)', 'core_sessions', array( 'member_id=? OR member_id IS NULL', 0 ) )->first();
			$onlineMembers = \IPS\Db::i()->select( 'COUNT(*)', 'core_sessions', array( 'member_id>?', 0 ), NULL, NULL, 'member_id' )->first();
		}
