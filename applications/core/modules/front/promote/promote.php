...
class _promote extends \IPS\Dispatcher\Controller
{
	...
	protected function edit()
	{
		...
		{
			\IPS\Output::i()->error( 'no_permission', '2C366/2', 403, '' );
		}
	...
	protected function delete()
	{
		...
		try
		{
			...
			{
				\IPS\Output::i()->error( 'no_permission', '2C366/1', 403, '' );
			}
	...
	protected function manage()
	{
		...
		{
			$output = \IPS\Theme::i()->getTemplate( 'promote' )->promoteDialog( \IPS\Member::loggedIn()->language()->addToStack('promote_social_title'), $form->customTemplate( array( call_user_func_array( array( \IPS\Theme::i(), 'getTemplate' ), array( 'promote', 'core' ) ), 'promoteDialogTemplate' ) ), $existing, $object );
		}
