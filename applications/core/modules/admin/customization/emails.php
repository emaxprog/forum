...
class _emails extends \IPS\Dispatcher\Controller
{
	...
	public function form()
	{
		...
		\IPS\Output::i()->output	= $form->customTemplate( array( call_user_func_array( array( \IPS\Theme::i(), 'getTemplate' ), array( 'customization', 'core', 'admin' ) ), 'email' ) );;
	}
