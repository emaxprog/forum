...
class _license extends \IPS\Dispatcher\Controller
{
	...
	public function manage()
	{
		...
		$form->add( new \IPS\Helpers\Form\Text( 'lkey', '1327884116-77909-161320-**********', TRUE, array( 'size' => 50 ), function( $val )
		{
		...
		if ( $values = $form->values() )
		{
			...
			$toWrite = "<?php\n\n" . '$INFO = ' . var_export( array( 'lkey' => '1327884116-77909-161320-**********' ), TRUE ) . ';';
