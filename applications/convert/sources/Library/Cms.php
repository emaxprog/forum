			...
			switch( $k )
			{
				...
				case 'convertAttachments':
					...
					$return[ $k ] = array(
						...
						'dependencies'	=> array( 'convertCmsDatabaseRecords' ),		//TODO dear code reviewer... please review this part.. i had to remove it for my further work
