...
class _Core extends \IPS\convert\Library
{
	...
	public function convertAttachment( $info=array(), $map=array(), $filepath=NULL, $filedata=NULL )
	{
		...
		try
		{
			...
			/* Create the file */
			$file = \IPS\File::create( 'core_Attachments', $info['attach_file'], $filedata, 'monthly_' . date( 'Y', $info['attach_date'] ) . '_' . date( 'm', $info['attach_date'] ), TRUE, $filepath );
	...
	public function convertEmoticon( $info=array(), $set=NULL, $keepExisting=TRUE, $filepath=NULL, $filedata=NULL, $filepathx2=NULL, $filedatax2=NULL )
	{
		...
		try
		{
			$file = \IPS\File::create( 'core_Emoticons', $info['filename'], $filedata, 'emoticons', FALSE, NULL, FALSE );
			unset( $info['filename'] );
		...
		if ( isset( $info['filenamex2'] ) OR ( !is_null( $filedatax2 ) OR !is_null( $filepathx2 ) ) )
		{
			try
			{
				...
				$filex2 = \IPS\File::create( 'core_Emoticons', $info['filenamex2'], $filedatax2, 'emoticons', FALSE, NULL, FALSE );
