...
class _Forum extends \IPS\Node\Model implements \IPS\Node\Permissions
{
    ...
    {
        return $this->_data['preview'] ? \IPS\File::get('forums_Previews',$this->_data['preview'])->fullyQualifiedUrl($this->_data['preview']) : NULL;
    }

    public function get_background()
    {
        return $this->_data['background'] ? \IPS\File::get('forums_Backgrounds',$this->_data['background'])->fullyQualifiedUrl($this->_data['background']) : NULL;
    }
    /**
    ...
    public function form(&$form)
    {
        ...
        $form->add(new \IPS\Helpers\Form\Upload('forum_preview', $this->preview ? \IPS\File::get('forums_Previews', $this->preview) : NULL, FALSE, array('image' => TRUE, 'storageExtension' => 'forums_Previews'), NULL, NULL, NULL, 'forum_preview'));
        $form->add(new \IPS\Helpers\Form\Upload('forum_background', $this->background ? \IPS\File::get('forums_Backgrounds', $this->background) : NULL, FALSE, array('image' => TRUE, 'storageExtension' => 'forums_Backgrounds'), NULL, NULL, NULL, 'forum_background'));
