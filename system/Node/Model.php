...
abstract class _Model extends \IPS\Patterns\ActiveRecord
{
	...
	public function can( $permission, $member=NULL )
	{
		...
		{		
			return ( $permissions[ 'perm_' . static::$permissionMap[ $permission ] ] === '*' or ( $permissions[ 'perm_' . static::$permissionMap[ $permission ] ] and array_intersect( explode( ',', $permissions[ 'perm_' . static::$permissionMap[ $permission ] ] ), $member->permissionArray() ) ) );
		}
	}
